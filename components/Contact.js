      ...
      <div className="flex flex-col lg:flex-row lg:items-center">
        ...
        <div className="bio hidden md:block p-4 lg:p-11  mt-6 lg:pt-11 lg:ml-11 w-12/12 lg:w-6/12 lg:mr-11">
          <Slide direction="up">
            ...
            <div className="flex items-center justify-center">
                  ...
                  <span className="text-sm md:text-lg text-white mt-6 font-semibold text-center">Phone Number :- (+91) 7439455470</span>
            </div>
            <div className="flex items-center justify-center">
              <Link href='https://www.google.com/gmail/' target='_blank'>
                <a className="text-white font-semibold mt-3 text-center">
                  ...
                  <span className=" text-sm md:text-lg" >Email :- dassourav55885@gmail.com</span>
                </a>
              </Link>
            </div>
          </Slide>
        ...
        <div className="bio md:hidden p-4 lg:p-11  mt-6 lg:pt-11 lg:ml-11 w-12/12 lg:w-6/12 lg:mr-11">
          <Slide direction="up">
            ...
            <div className="flex items-center justify-center">
                  <span className="text-xs md:text-lg text-white mt-6 font-semibold text-center">Phone Number :- (+91) 7439455470</span>
            </div>
            <div className="flex items-center justify-center">
              <Link href='https://www.google.com/gmail/' target='_blank'>
                <a className="text-white font-semibold mt-3 text-center">
                  <span className=" text-xs md:text-lg" >Email :- dassourav55885@gmail.com</span>
                </a>
              </Link>
            </div>
          </Slide>
